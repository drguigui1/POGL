...
shared_lights init_museum_entrance_lights() {
    ...
    DirectionalLight dir_light(glm::vec3(0.8f, 0.8f, 0.8f), glm::vec3(-5.0f, -5.0f, -5.0f));
    PointLight p_light1(l_color, glm::vec3(-9.0f, 5.0f, 30.0f), 1.0f, 0.09f, 0.032f);
    PointLight p_light2(l_color, glm::vec3(-18.0f, 5.0f, 7.0f), 1.0f, 0.09f, 0.032f);
    PointLight p_light3(l_color, glm::vec3(-12.0f, 5.0f, 7.0f), 1.0f, 0.09f, 0.032f);
    PointLight p_light4(l_color, glm::vec3( -6.0f, 5.0f, 7.0f), 1.0f, 0.09f, 0.032f);
    PointLight p_light5(l_color, glm::vec3(  0.0f, 5.0f, 7.0f), 1.0f, 0.09f, 0.032f);
    PointLight p_light6(l_color, glm::vec3(  6.0f, 5.0f, 7.0f), 1.0f, 0.09f, 0.032f);
    PointLight p_light7(l_color, glm::vec3( 12.0f, 5.0f, 7.0f), 1.0f, 0.09f, 0.032f);
